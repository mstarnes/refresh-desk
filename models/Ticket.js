...
const CcEmailSchema = new Schema({
...
const ReportsDataSchema = new Schema({
  account_id: { type: Schema.Types.ObjectId, ref: 'Account', required: true },
  ...
  last_resolved_at: { type: Date, default: null },
...
const TicketStatesSchema = new Schema({
  ...
  requester_responded_at: { type: Date },
  agent_responded_at: { type: Date },
  created_at: { type: Date, default: Date.now },
  updated_at: { type: Date, default: Date.now },
  group_escalated: { type: Boolean },
  inbound_count: { type: Number },
  status_updated_at: { type: Date },
  sla_timer_stopped_at: { type: Date },
  ...
  resolution_time_updated_at: { type: Date, default: null },
});
...
const TicketSchema = new Schema({
  ...
  account_id: { type: Schema.Types.ObjectId, ref: 'Account', required: true },
  description: { type: String },
  requester_id: { type: Schema.Types.ObjectId, ref: 'User'}, // Updated
  ...
  sl_manual_dueby: { type: Date, default: null },
  ...
  nr_due_by: { type: Date, default: null },
  ...
  datetime_tc01: { type: Date, default: null },
  datetime_tc02: { type: Date, default: null },
  datetime_tc03: { type: Date, default: null },
